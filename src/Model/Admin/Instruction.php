...
use App\Interface\File;

class Instruction implements File
{
    public int $id;
    public string $title;
    ...
    public string $type;
    public int $size;
    public string $table = 'instructions';

    public function __construct(string $filename, string $size, string $type)
    {
