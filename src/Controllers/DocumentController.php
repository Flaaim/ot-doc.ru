...
class DocumentController extends AbstractController
{
    public function document($data): void
    {
        ...
        if($template) {
            ...
            $this->render('templates/' . $template->slug . '/index.twig', ['template' => $template, 'lasts' => $lasts, 'documents' => $documents, 'pagination' => $pagination, 'total' => $total]);
        }
    }
    ...
    public function get($data): void
    {
        ...
        if($template) {
            ...
            $this->render('templates/get_one.twig',
                ['document' => $document, 'profile' => $profile ?? null, 'subscribe' => $subscribe ?? null, 'preview_document' => $preview_document, 'lasts' => $lasts, 'template' => $template]);
        }
    }
}