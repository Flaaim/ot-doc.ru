...
final class Pagination
{
    ...
    public function getHtml()
    {
        ...
        if($this->currentPage > 1){
            $back = "<li class='page-item'><a class='page-link' href='".$this->getLink($this->currentPage - 1)."'>Назад</a></li>";
        }

        //Forward
        if($this->currentPage < $this->countPages){
            $forward = "<li class='page-item'><a class='page-link' href='".$this->getLink($this->currentPage + 1)."'>Вперед</a></li>";
        }
        //Startpage
        if($this->currentPage > 3){
            $startpage = "<li class='page-item'><a class='page-link' href='".$this->getLink(1)."'>Первая страница</a></li>";
        }
        //Endpage
        if($this->currentPage < $this->countPages - 2){
            $endpage = "<li class='page-item'><a class='page-link' href='".$this->getLink($this->countPages)."'>Последняя страница</a></li>";
        }
        //Page2Left
