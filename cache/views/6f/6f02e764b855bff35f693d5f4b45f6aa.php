...
class __TwigTemplate_25640682804066ae62a4da03a6cd2749 extends Template
{
        ...
        yield "            </div>
            ...
            <div class=\"col-md-6 col-sm-12 mt-5 \">
                ...
                <div class=\"preview\">
                        ";
        // line 29
        if (array_key_exists("preview_document", $context)) {
            // line 30
...
";
    ...
    {
        return array (  146 => 34,  142 => 32,  136 => 30,  134 => 29,  127 => 24,  125 => 23,  119 => 20,  115 => 19,  111 => 18,  107 => 17,  101 => 16,  97 => 15,  92 => 12,  85 => 11,  75 => 8,  68 => 7,  60 => 4,  53 => 3,  42 => 1,);
    }
    ...
    <div class=\"container pb-3 mb-12\">
        <div class=\"row my-5\">
            ...
            <div class=\"col-md-6 col-sm-12 mt-5 \">
                <h5 class=\"mb-3\">Предварительный просмотр текста документа</h5>
                <div class=\"preview\">
                        {% if preview_document is defined %}
...
{% endblock %}", "templates/instructions/get_one.twig", "C:\\OSPanel\\domains\\iot-help2\\src\\views\\templates\\instructions\\get_one.twig");
    }
}
