...
class __TwigTemplate_ffb50d8d53a8091af6818a04a41c4c0d extends Template
{
...
{% block description %}
    Это динамическая страница шаблонов (образцов) документов формируемая на стороне клиента с помощью js библиотеки.
{% endblock %}
...
{% endblock %}", "templates/js_table.twig", "C:\\OSPanel\\domains\\iot-help2\\src\\views\\templates\\js_table.twig");
    }
}
