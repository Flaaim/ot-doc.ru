...
/* templates/provisions/index.twig */
class __TwigTemplate_347a1b1bfdacde519017b81b4bbe5776 extends Template
{
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("layouts/layout.twig", "templates/provisions/index.twig", 1);
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 4
        yield "    Шаблоны (образцы) положений по охране труда, промышленнойбезопасности, пожбезопасности и другие
";
        yield from [];
    }
    ...
    public function block_description(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 8
        yield "    Шаблоны положений по различным направлениям работы. Положения по охране труда, промышленной безопасности и другим смежным направлениям.
";
        yield from [];
    }
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        <div class=\"row mt-3\">
            <div class=\"col-md-12 mt-5\">
                <h1 class=\"mb-5\">Образцы (шаблоны) положений</h1>
                <p>
                    Ниже в таблице вы найдете образцы (шаблоны) типовых положений для организации работы в области охраны труда, промышленной и пожарной безопасности.
                </p>
                <p> <b>Всего положений: ";
        // line 19
        ...
        <div class=\"row mt-3\">
            <div class=\"col-md-12 \">
                <h2>Последние добавленные положения</h2>
...
";
    ...
    {
        return "templates/provisions/index.twig";
    }
...
{% block title %}
    Шаблоны (образцы) положений по охране труда, промышленнойбезопасности, пожбезопасности и другие
{% endblock %}

{% block description %}
    Шаблоны положений по различным направлениям работы. Положения по охране труда, промышленной безопасности и другим смежным направлениям.
{% endblock %}
...
{% endblock %}", "templates/provisions/index.twig", "C:\\OSPanel\\domains\\iot-help2\\src\\views\\templates\\provisions\\index.twig");
    }
}
