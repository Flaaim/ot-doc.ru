...
/* templates/provisions/get_one.twig */
class __TwigTemplate_75bd01ffa4fa099557785ebebf615c4b extends Template
{
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("layouts/layout.twig", "templates/provisions/get_one.twig", 1);
...
";
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        yield "</p>
                ...
                ";
        // line 23
        yield from $this->loadTemplate("/templates/parts/download.twig", "templates/provisions/get_one.twig", 23)->unwrap()->yield($context);
        // line 24
        yield "            </div>
            <div class=\"col-md-6 col-sm-12 mt-5 \">
...
";
    ...
    {
        return "templates/provisions/get_one.twig";
    }
    ...
    {
        return array (  133 => 29,  127 => 24,  125 => 23,  119 => 20,  115 => 19,  111 => 18,  107 => 17,  101 => 16,  97 => 15,  92 => 12,  85 => 11,  75 => 8,  68 => 7,  60 => 4,  53 => 3,  42 => 1,);
    }
    ...
    <div class=\"container pb-3 mb-12\">
        <div class=\"row mt-3\">
            ...
            <div class=\"col-md-6 col-sm-12 mt-5 \">
                <h5 class=\"mb-3\">Предварительный просмотр текста документа</h5>
                <div class=\"preview\">
                    {#                    <iframe src=\"{{ preview_document|raw }}\" height=\"400\" style=\"border: none;\"></iframe>#}
                    <div oncontextmenu=\"return false;\" onselectstart=\"return false;\">{{ preview_document|raw }}</div>
                </div>
            </div>
        </div>
    </div>
{% endblock %}", "templates/provisions/get_one.twig", "C:\\OSPanel\\domains\\iot-help2\\src\\views\\templates\\provisions\\get_one.twig");
    }
}
