...
/* /parts/footer.twig */
class __TwigTemplate_0df9d2f40869f7151705f922d43ec396 extends Template
{
    ...
    <div class=\"container\">
        <div class=\"row\">
            <div class=\"col-sm-12 col-md-6 my-3\">
                <div class=\"d-flex flex-column py-3\">
                    <small class=\"text-muted \">©2024-{{ 'now' | date('Y') }} ot-doc.ru. Шаблоны документов по охране труда.</small>
                    <small class=\"text-muted\">Сервис содержит образцы документов по охране труда (инструкции, приказы, положения и т.д.) для скачивания и дальнейшего использования в работе.</small>
                </div>
            </div>
            <div class=\"col-sm-12 col-md-6 my-3\">
...
</footer>", "/parts/footer.twig", "/var/www/u1656040/data/www/ot-doc.ru/src/views/parts/footer.twig");
    }
}
