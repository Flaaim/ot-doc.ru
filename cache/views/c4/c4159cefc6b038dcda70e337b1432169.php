...
/* /admin/template/programs/upload.twig */
class __TwigTemplate_012eb79ab2c28af63d6b6e981c3360a2 extends Template
{
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("layouts/admin_layout.twig", "/admin/template/programs/upload.twig", 1);
...
";
    ...
    {
        return "/admin/template/programs/upload.twig";
    }
...
{#                                    </div>#}
    ...
    <!-- /.content-wrapper -->
{% endblock %}", "/admin/template/programs/upload.twig", "C:\\OSPanel\\domains\\iot-help2\\src\\views\\admin\\template\\programs\\upload.twig");
    }
}
