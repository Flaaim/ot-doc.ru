...
/* templates/other/index.twig */
class __TwigTemplate_a6d1990a89269c88a2760b1e80d3ed59 extends Template
{
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("layouts/layout.twig", "templates/other/index.twig", 1);
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 4
        yield "    Шаблоны (образцы) прочих документов по охране труда, промышленной безопасности, пожбезопасности и другие
";
        yield from [];
    }
    ...
    public function block_description(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 8
        yield "    Шаблоны прочих документов (графики, акты, перечни и т.д.)  по охране труда, которые охватывают различные направления работы специалистов на предприятии.
";
        yield from [];
    }
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        <div class=\"row mt-3\">
            <div class=\"col-md-12 mt-5\">
                <h1 class=\"mb-5\">Образцы (шаблоны) прочих документов</h1>
                <p>
                    Ниже в таблице вы найдете образцы (шаблоны) прочих документов по охране труда, таких как графики, акты, перечни, списки и т.д., которые не вошли в остальные шаблоны документов.
                </p>
                <div class=\"attention\">
                    <h5>Внимание!</h5>
        ...
        <div class=\"row mt-3\">
            <div class=\"col-md-12 \">
                <h2>Последние добавленные прочие документы</h2>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["document"]) {
            ...
            yield "\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["document"], "title", [], "any", false, false, false, 59), "html", null, true);
            yield "</a></small>
                                </div>
                            </div>
...
";
    ...
    {
        return "templates/other/index.twig";
    }
...
{% block title %}
    Шаблоны (образцы) прочих документов по охране труда, промышленной безопасности, пожбезопасности и другие
{% endblock %}

{% block description %}
    Шаблоны прочих документов (графики, акты, перечни и т.д.)  по охране труда, которые охватывают различные направления работы специалистов на предприятии.
{% endblock %}
...
{% endblock %}", "templates/other/index.twig", "C:\\OSPanel\\domains\\iot-help2\\src\\views\\templates\\other\\index.twig");
    }
}
