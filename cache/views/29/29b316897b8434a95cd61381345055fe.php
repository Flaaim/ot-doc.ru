...
/* app/index.twig */
class __TwigTemplate_e33e907536d70ca288a98b8d80354db0 extends Template
{
...
";
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["template"]) {
            ...
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["template"], "id", [], "any", false, false, false, 29), "html", null, true);
            yield "\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["template"], "name", [], "any", false, false, false, 29), "html", null, true);
            yield "</a></li>
                          ";
        }
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["document"]) {
            ...
            // line 47
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["document"], "template_id", [], "any", false, false, false, 47), "html", null, true);
            yield "/";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["document"], "id", [], "any", false, false, false, 47), "html", null, true);
            yield "\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["document"], "title", [], "any", false, false, false, 47), "html", null, true);
            yield "</a></small>
                            </div>
                        </div>
            ...
            // line 51
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["document"], "date", [], "any", false, false, false, 51), "d.m.Y"), "html", null, true);
            yield "</span>
                            <span>Размер:  ";
            // line 52
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["document"], "size", [], "any", false, false, false, 52), "html", null, true);
            yield "</span>
                            <span><i class=\"fa-solid fa-download\"></i> ";
            // line 53
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["document"], "count", [], "any", false, false, false, 53), "html", null, true);
            yield "</span>
                        </div>
                    </div>
                ";
...
";
    ...
    {
        return array (  171 => 57,  161 => 53,  157 => 52,  153 => 51,  142 => 47,  137 => 44,  133 => 43,  119 => 31,  108 => 29,  104 => 28,  86 => 12,  79 => 11,  73 => 9,  66 => 8,  60 => 5,  53 => 4,  42 => 1,);
    }
...
{% block description %}
    Данный сервис содержит шаблоны инструкций, приказов, положений, программ, журналов и прочих документов по охране труда и смежных с ней направлений, таких как пожарная и промышленная безопасность.
{% endblock %}
{% block content %}
    <main id=\"front-page\" class=\"site-main mt-5\">
        <div class=\"container pb-3 mb-12\">
            <div class=\"row d-flex justify-content-center\">
                <div class=\"col-md-12 mt-5\">
                    <h1>Шаблоны документов по охране труда</h1>
                  ...
                  <div class=\"input-group\">
                      ...
                      <ul class=\"dropdown-menu\">
                          {% for template in templates %}
                            <li><a class=\"dropdown-item templateList\" href=\"#\" data-template=\"{{ template.id }}\">{{ template.name }}</a></li>
                          {% endfor %}
                      </ul>
                      <input type=\"text\" class=\"form-control\" id=\"s\" placeholder=\"Введите наименование...\" aria-label=\"Введите наименование...\" aria-describedby=\"button-addon2\">
                      <button class=\"btn btn-outline-secondary\"  type=\"button\" id=\"search\">Поиск</button>
...
{% endblock %}", "app/index.twig", "/var/www/u1656040/data/www/ot-doc.ru/src/views/app/index.twig");
    }
}
