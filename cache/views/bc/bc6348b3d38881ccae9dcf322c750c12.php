...
class __TwigTemplate_b300ca1505fc1d53a0239ef73cfca3af extends Template
{
...
";
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["instruction"]) {
            ...
            // line 50
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["instruction"], "template_id", [], "any", false, false, false, 50), "html", null, true);
            yield "/";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["instruction"], "id", [], "any", false, false, false, 50), "html", null, true);
            yield "\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["instruction"], "title", [], "any", false, false, false, 50), "html", null, true);
            yield "</a></small>
                                </div>
                            </div>
            ...
            // line 54
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["instruction"], "date", [], "any", false, false, false, 54), "d.m.Y"), "html", null, true);
            yield "</span>
                                <span>Размер:  ";
            // line 55
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["instruction"], "size", [], "any", false, false, false, 55), "html", null, true);
            yield "</span>
                                <span><i class=\"fa-solid fa-download\"></i> ";
            // line 56
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["instruction"], "count", [], "any", false, false, false, 56), "html", null, true);
            yield "</span>
                            </div>
                        </div>
                    ";
...
";
    ...
    <script src=\"";
        // line 71
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["init"] ?? null), "PATH", [], "any", false, false, false, 71), "html", null, true);
...
";
    ...
    {
        return array (  188 => 71,  182 => 69,  175 => 68,  164 => 60,  154 => 56,  150 => 55,  146 => 54,  135 => 50,  130 => 47,  126 => 46,  103 => 26,  87 => 12,  80 => 11,  74 => 8,  67 => 7,  61 => 4,  54 => 3,  43 => 1,);
    }
...
{% endblock %}", "templates/orders/index.twig", "/var/www/u1656040/data/www/ot-doc.ru/src/views/templates/orders/index.twig");
    }
}
