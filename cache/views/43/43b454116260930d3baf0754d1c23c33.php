...
/* /cabinet/index.twig */
class __TwigTemplate_90ade06299e3372aaecb135e46ce1a5c extends Template
{
        ...
        <div class=\"row mt-3\">
            <div class=\"col-md-10 col-sm-12 mt-5\">
                ...
                <div class=\"mt-3\">
                    ...
                    <div class=\"input-group mb-3\">
                        <span class=\"input-group-text\">Доступное количество скачиваний:</span>
                        <span class=\"input-group-text\">{{ profile.attempts }}</span>
                    </div>
                    {% endif %}
                    <div class=\"input-group mb-3\">
                        <span class=\"input-group-text\">Подписка:</span>
                            {% if subscribe.status == 'active' %}
                            <span class=\"input-group-text\">до {{ subscribe.end_date|date('d.m.Y') }} г.</span>
                            {% else %}
                                <span class=\"input-group-text\">Не действует</span>
                                <span class=\"input-group-text\">
                                    <a href=\"/payment/subscribe\">Приобрести</a>
                                </span>
                            {% endif %}
...
{% endblock %}", "/cabinet/index.twig", "/var/www/u1656040/data/www/ot-doc.ru/src/views/cabinet/index.twig");
    }
}
