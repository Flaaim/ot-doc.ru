...
class __TwigTemplate_c9d9aa22388370ae87b35ef574095fa4 extends Template
{
...
";
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        // line 39
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["template"] ?? null), "name", [], "any", false, false, false, 39), "html", null, true);
        yield "</h2>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["document"]) {
            ...
            // line 46
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["document"], "template_id", [], "any", false, false, false, 46), "html", null, true);
            yield "/";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["document"], "id", [], "any", false, false, false, 46), "html", null, true);
            yield "\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["document"], "title", [], "any", false, false, false, 46), "html", null, true);
            yield "</a></small>
                                </div>
                            </div>
            ...
            // line 50
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["document"], "date", [], "any", false, false, false, 50), "d.m.Y"), "html", null, true);
            yield "</span>
                                <span>Размер:  ";
            // line 51
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["document"], "size", [], "any", false, false, false, 51), "html", null, true);
            yield "</span>
                                <span><i class=\"fa-solid fa-download\"></i> ";
            // line 52
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["document"], "count", [], "any", false, false, false, 52), "html", null, true);
            yield "</span>
                            </div>
                        </div>
                    ";
...
";
    ...
    {
        return array (  197 => 56,  187 => 52,  183 => 51,  179 => 50,  168 => 46,  163 => 43,  159 => 42,  153 => 39,  146 => 34,  140 => 32,  136 => 30,  134 => 29,  127 => 24,  125 => 23,  119 => 20,  115 => 19,  111 => 18,  107 => 17,  101 => 16,  97 => 15,  92 => 12,  85 => 11,  75 => 8,  68 => 7,  60 => 4,  53 => 3,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "templates/get_one.twig", "/var/www/u1656040/data/www/ot-doc.ru/src/views/templates/get_one.twig");
    }
}
